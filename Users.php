...
<div class="container">
               ...
               <?php
                ...
                {?>
                    ...
                    <tr>
                    <th><h6 class="text-center">First Name</h6></th>
                    <th><h6 class="text-center">Last Name</h6></th>
                    <th><h6 class="text-center">Username</h6></th>
                    <th><h6 class="text-center">Email Address</h6></th>
                    <th><h6 class="text-center">Date</h6></th>
                    <tr>
                    </table>
                    <?php
                    while($row = mysqli_fetch_array($result)) {?>
                        ...
                        <form method="post" action="Users.php?id=<?=$row['id']?>">
                            <tr>
                            <td><h6 class="text-center"><?= $row['fname']; ?></h6></td>
                            <td><h6 class="text-center"><?= $row['lname']; ?></h6></td>
                            <td><h6 class="text-center"><?= $row['username']; ?></h6></td>
                            <td><h6 class="text-center"><?= $row['email']; ?></h6></td>
                            <td><h6 class="text-center"><?= $row['date']; ?></h6></td>
                        </tr>
                        </form>
