...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2022 at 12:55 PM
...
INSERT INTO `feedback` (`id`, `fname`, `lname`, `email`, `mobile`, `feedback`) VALUES
(1, 'Durva', 'Patel', 'durva.patel2003', 21472222, 'Thank you for your service'),
(4, 'heta', 'shah', 'shahheta2209@gmail.com', 897684939, 'very good service'),
(5, 'Kresha', 'Shah', 'kresha@2003', 98334544, 'Bad user experience');
...
(1, 'Ambadi Road, Vasai Road(West)', 'Mumbai', 'Maharahtra', 401202),
(9, 'Jai Apt, Bahayander(West)', 'Mumbai', 'Maharahtra', 401202);
...
(4, 'Harry', 'State', 'harry', 'harry2019@gmail.com', '$2y$04$maDVDcoy0msNWZ/UJHPcfuSfy31xx/gYMXL3mBLLBkoDZwOhNeNX2', '2022-07-11', '');
