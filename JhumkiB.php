...
$del = mysqli_query($connect,"DELETE from jhumkibangles where id = '$id'"); // delete query

if($del)
{
    mysqli_close($connect); // Close connection
    header("location:JhumkiB.php"); // redirects to all records page
    exit;   
}
else
{
...
<br><br>
<div class="col-md-12">
                    <h2 class="text-center">Jhumki Bangles</h2>
                    <div class="col-md-12">
                        <div class= "row">

                    <?php
                    $query = "SELECT * FROM jhumkibangles";
                    $result = mysqli_query($connect,$query);

                    while($row = mysqli_fetch_array($result)) {?>
 
                    <div class="col-md-4"><br>
                        <form method="post" action="JhumkiB.php?id=<?=$row['id']?>">
                         <img src="img/<?= $row['img'] ?>" style='width: 100%;'>
                            ...
                            <center>
                            <a href="AddPro.php" class="btn btn-info">Add </a>
                            <input type="submit" class="btn btn-info" name="submit" value="Remove">
                            </center>
                        </form>
                    </div>
