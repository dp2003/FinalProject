...
<div class="main">
  <center>
<br><a href="ThreadUpdate.php" style="color:#3c3c3c">
      <div class="polaroid">
        <img src="ThreadB.jpg" style="width:100%">
        <div class="container">
          <p>THREAD BANGLES</p>
        </div>
         <a href="ThreadUpdate.php" class="button">Update Products</a>
      </div>
    </a>
      <a href="VelvetUpdate.php" style="color:#3c3c3c">
      <div class="polaroid">
        <img src="velvet.jpg"  style="width:100%">
        <div class="container">
          <p>VELVET BANGLES</p>
        </div>
        <a href="VelvetUpdate.php" class="button">Update Products</a>
      </div>
      </a>
      <a href="PearlUpdate.php" style="color:#3c3c3c">
      <div class="polaroid">
        <img src="Pearl.jpg"  style="width:100%">
        <div class="container">
          <p>PEARL BANGLES</p>
        </div>
        <a href="PearlUpdate.php" class="button">Update Products</a>
      </div>
      </a>
      <a href="JhumkiUpdate.php" style="color:#3c3c3c">
      <div class="polaroid">
        <img src="Jhumki.jpg"  style="width:100%">
        <div class="container">
          <p>JHUMKI BANGLES</p>
        </div>
        <a href="JhumkiUpdate.php" class="button">Update Products</a>
      </div>
      </a>
      <a href="SetUpdate.php" style="color:#3c3c3c">
      <div class="polaroid">
        <img src="set.jpg"  style="width:100%">
        <div class="container">
          <p>BANGLE SET</p>
        </div>
        <a href="SetUpdate.php" class="button">Update Products</a>
      </div>
      </a>
      
      <a href="PaatlaUpdate.php" style="color:#3c3c3c">
      <div class="polaroid">
        <img src="paatla.jpg"  style="width:98.5%"> 
        <div class="container">
          <p>PAATLA</p>
        </div>
        <a href="PaatlaUpdate.php" class="button">Update Products</a>
      </div>
      </a>
      <center>
  </div>
