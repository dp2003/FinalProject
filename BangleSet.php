...
if($del)
{
    ...
    header("location:BangleSet.php"); // redirects to all records page
    exit;   
}
else
{
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <form method="post" action="BangleSet.php?id=<?=$row['id']?>">
                ...
                <div class="col-md-6">
                    ...
                    if(!empty($_SESSION['cart'])){
                        ...
                        foreach($_SESSION['cart'] as $key => $value){
                            ...
                            <td><a href= 'BangleSet.php?action=remove&id=".$value['id']."'>
                        ...
                        <td>
                        <a href = 'BangleSet.php?action=clearall'>
