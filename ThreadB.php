...
$del = mysqli_query($connect,"DELETE from threadbangles where id = '$id'"); // delete query

if($del)
{
    mysqli_close($connect); // Close connection
    header("location:ThreadB.php"); // redirects to all records page
    exit;   
}
else
{
...
<br><br>
<div class="col-md-12">
                    <h2 class="text-center">Thread Bangles</h2>
                    <div class="col-md-12">
                        <div class= "row">
                    ...
                    <div class="col-md-4"><br>
                        <form method="post" action="ThreadB.php?id=<?=$row['id']?>">
