...
if(count($_POST)>0) {
mysqli_query($dbc,"UPDATE threadbangles set id='" . $_POST['id'] . "', code='" . $_POST['code'] . "', price='" . $_POST['price'] . "', img='" . $_POST['img'] . "' WHERE id='" . $_POST['id'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($dbc,"SELECT * FROM threadbangles WHERE id ='" . $_GET['id'] . "'");
