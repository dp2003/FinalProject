...
$del = mysqli_query($connect,"DELETE from paatla where id = '$id'"); // delete query

if($del)
{
    mysqli_close($connect); // Close connection
    header("location:PaatlaB.php"); // redirects to all records page
    exit;   
}
else
{
...
<br><br>
<div class="col-md-12">
                    <h2 class="text-center">Paatla</h2>
                    <div class="col-md-12">
                        <div class= "row">

                    <?php
                    $query = "SELECT * FROM paatla";
                    $result = mysqli_query($connect,$query);

                    while($row = mysqli_fetch_array($result)) {?>
 
                    <div class="col-md-4"><br>
                        <form method="post" action="PaatlaB.php?id=<?=$row['id']?>">
