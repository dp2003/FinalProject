        ...
        <div class="collapse navbar-collapse" id="navbarNav">
         ...
         <li class="nav-item">
           ...
           <i class="bi bi-cart"></i>
            <a href="cart.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-cart" viewBox="0 0 16 16">
		...
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="col-md-6">
						<form method="post" action="Thread.php?id=<?=$row['id']?>">
				...
				<div class="col-md-6">
					...
					if(!empty($_SESSION['cart'])){
						...
						<td>
						<a href = 'Thread.php?action=clearall'>
